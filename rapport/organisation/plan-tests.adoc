...
|Classification de l'image | Photo traitée type utilisateur| Vecteur de probabilité| Non| Photo similaire à celle que l'utilisateur prendra: résolution, éclairage aléatoire, background, format (à fignoler)
|====