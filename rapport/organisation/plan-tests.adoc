...
|Classification de l'image | Photo traitée type utilisateur| Vecteur de probabilités d'appartenance aux classes| Non| Photo similaire à celle que l'utilisateur prendra: résolution, éclairage aléatoire, background, format (à fignoler)
|====