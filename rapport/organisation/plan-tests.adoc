...
Cette section décrit les plans de test, mais les tests précis sont explicités dans les fichiers:
"tests_unitaires.adoc",'tests_intefration.adoc',"tests_scenario.adoc".
