{
 "cells": [
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "DIR_INPUT = '/data/plant-pathology-2020-fgvc7'\n",
    "\n",
    "SEED = 42\n",
    "N_FOLDS = 5\n",
    "N_EPOCHS = 10\n",
  ...
  },
  {
   ...
   "source": [
    "submission_df = pd.read_csv('./data/plant-pathology-2020-fgvc7/sample_submission.csv')\n",
   ...
   "outputs": [
    ...
    },
    {
     ...
     "traceback": [
      ...
      "\u001b[1;31mRuntimeError\u001b[0m: DataLoader worker (pid(s) 24108, 30920, 8000, 18260) exited unexpectedly"
     ]
    }
   ],
   "source": [
